    ...
    return (
        <div id="hero" className="bg-green-900/50 md:h-[70vh] h-[80vh] items-center ">
            <div className=" flex flex-col md:flex-row items-center max-w-7xl mx-auto md:pt-24 p-6">
                <div data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="200" className="md:gap-10 gap-6 flex flex-col h-full ">
                    ...
                    <div className="flex gap-5 text-black ">
                        <Link href="#/"> <button data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="200" className="bg-white px-5 py-3 font-bold rounded-lg cursor-pointer">Shop Now</button></Link>
                        <Link href="#products"><button data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="200" className="bg-black text-white px-5 py-3 font-bold rounded-lg cursor-pointer">Explore Products</button></Link>
                    </div>
